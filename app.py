...
(() => {
  ...
  canvas.addEventListener('click', (e) => {
    ...
    // Prefer spawning BC near the edge of the circle to show alternatives
    const type = Math.random() < 0.35 ? 'BC' : 'AD';
...
@app.route('/health')
def health():
    return {'status': 'ok', 'model': 'Doom-Endpoint Convergence MMO', 'polarity_target': '5/11'}
...
if __name__ == '__main__':
    ...
    print("  Click to spawn · A = Asimila · P = Endpoint Pulse · R = Reset")
    print("=" * 60)
